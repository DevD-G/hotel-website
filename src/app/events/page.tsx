    ...
    <div>
      ...
      <section className="relative h-[455px]">
        ...
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
          <div className="text-center text-white">
            <p className="section-divider text-[var(--color-gold)] text-sm uppercase tracking-[0.3em] mb-3 font-[family-name:var(--font-jost)]">Events & Gatherings</p>
            <h1 className="text-4xl md:text-5xl font-semibold font-[family-name:var(--font-jost)]">Unique Event Spaces</h1>
            <p className="mt-3 text-gray-300">Rooftops, terraces & banquet halls for every occasion</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-semibold text-[var(--color-navy)] font-[family-name:var(--font-jost)] mb-6">Host Your Next Event with Us</h2>
      ...
      {/* Event Spaces */}
      <section className="py-16 px-4 bg-[var(--color-light-gray)]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-semibold text-[var(--color-navy)] font-[family-name:var(--font-jost)] mb-10 text-center">Our Event Venues</h2>
          <div className="space-y-10">
            {eventSpaces.map((space, i) => (
              <div key={i} className="bg-white rounded-xl overflow-hidden shadow-lg grid grid-cols-1 lg:grid-cols-2">
                <ImagePlaceholder number={space.imgNum} label={space.imgLabel} className="w-full h-72 lg:h-full !rounded-none" aspect="" />
                <div className="p-8">
                  <div className="text-xs text-[var(--color-primary)] font-semibold uppercase tracking-wider mb-2 font-[family-name:var(--font-jost)]">{space.property}</div>
                  <h3 className="text-xl font-semibold text-[var(--color-navy)] font-[family-name:var(--font-jost)] mb-4">{space.name}</h3>
                  ...
                  <Link href="/contact" className="inline-block bg-[var(--color-primary)] text-white px-6 py-2.5 rounded-md text-sm font-semibold uppercase tracking-wider hover:bg-[var(--color-primary-dark)] transition-colors font-[family-name:var(--font-jost)]">
                    Enquire Now
                  </Link>
                </div>
              </div>
      ...
      {/* CTA */}
      <section className="py-16 px-4 bg-[var(--color-brown)]">
        <div className="max-w-3xl mx-auto text-center text-white">
          <PartyPopper className="w-10 h-10 mx-auto mb-4 text-[var(--color-gold-light)]" />
          <h2 className="text-3xl font-semibold font-[family-name:var(--font-jost)] mb-4">Planning Something Special?</h2>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link href="/contact" className="inline-block bg-[var(--color-primary)] text-white px-8 py-3.5 rounded-md font-semibold uppercase tracking-wider text-sm hover:bg-[var(--color-primary-dark)] transition-colors font-[family-name:var(--font-jost)]">Contact Us</Link>
            <a href="tel:+917011080455" className="inline-block border-2 border-white text-white px-8 py-3.5 rounded-md font-semibold uppercase tracking-wider text-sm hover:bg-white hover:text-[var(--color-navy)] transition-colors font-[family-name:var(--font-jost)]">Call Now</a>
          </div>
        </div>
      </section>
    </div>
