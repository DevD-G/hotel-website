    ...
    <div>
      ...
      <section className="relative h-[350px]">
        ...
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
          <div className="text-center text-white">
            <p className="section-divider text-[var(--color-gold)] text-sm uppercase tracking-[0.3em] mb-3 font-[family-name:var(--font-jost)]">The Kitchen Confidence</p>
            <h1 className="text-4xl md:text-5xl font-semibold font-[family-name:var(--font-jost)]">Dining & Catering</h1>
            <p className="mt-3 text-gray-300">In-house commercial kitchens at every property</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="section-divider text-[var(--color-gold)] text-sm uppercase tracking-[0.25em] mb-3 font-[family-name:var(--font-jost)] justify-start">Our Approach</p>
            <h2 className="text-3xl font-semibold text-[var(--color-navy)] font-[family-name:var(--font-jost)] mb-6">The Engine: In-House Commercial Kitchens</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-4 bg-[var(--color-light-gray)] rounded-lg">
                  ...
                  <h4 className="font-semibold text-[var(--color-navy)] text-sm font-[family-name:var(--font-jost)]">{item.title}</h4>
      ...
      <section className="py-20 px-4 bg-[var(--color-cream)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-semibold text-[var(--color-navy)] font-[family-name:var(--font-jost)]">Our Dining Services</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  <h3 className="text-lg font-semibold text-[var(--color-navy)] font-[family-name:var(--font-jost)] mb-3">{service.title}</h3>
      ...
      <section className="py-16 px-4 bg-[var(--color-primary)]">
        <div className="max-w-3xl mx-auto text-center text-white">
          <h2 className="text-3xl font-semibold font-[family-name:var(--font-jost)] mb-4">Plan Your Next Corporate Event</h2>
          <p className="text-blue-100 mb-8">Get in touch with our team to customize a dining experience for your group or event.</p>
          <Link href="/contact" className="inline-block bg-white text-[var(--color-primary)] px-8 py-3.5 rounded-md font-semibold uppercase tracking-wider text-sm hover:bg-gray-100 transition-colors font-[family-name:var(--font-jost)]">Contact Us</Link>
        </div>
      </section>
    </div>
  );
